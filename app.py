...
st.markdown("""
            <div style="text-align: justify;">
                ...
                Discipliné, réfléchi et passionné de sports, je suis à la recherche d'une expérience professionnelle en tant que <b>data scientist</b> dans un domaine lié à la performance athlétique.   
            </div>
            """, unsafe_allow_html=True)
...
st.write("📚 Documentation personnelle - _Podcasts, livres, articles scientifiques_") 